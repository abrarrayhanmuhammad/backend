...
<!-- Mirrored from ableproadmin.com/application/ecom_product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:50 GMT -->
<head>
          ...
          <div class="card table-card">
            <div class="card-body">
              <div class="text-end p-4 pb-0">
                <a href="{{ route('ecomproductadd') }}" class="btn btn-primary d-inline-flex align-items-center">
                  ...
                  <tbody>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-1.jpg" alt="user-image"
                      ...
                      <td class="text-center">
                        <ul class="list-inline me-auto mb-0">
                          ...
                          <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Edit">
                            <a href="{{ route('ecomproductadd') }}" class="avtar avtar-xs btn-link-success btn-pc-default">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-2.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-3.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-4.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                            <h6 class="mb-1">Apple Series 4 GPS A38 MM Space</h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-5.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                            <h6 class="mb-1">Boat On-Ear Wireless</h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-6.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                            <h6 class="mb-1">Fitbit MX30 Smart Watch</h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-7.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                            <h6 class="mb-1">Apple Series 4 GPS A38 MM Space</h6>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                          <div class="col-auto pe-0">
                            <img src="/img/application/img-prod-8.jpg" alt="user-image"
                              class="wid-40 rounded">
                          </div>
                          <div class="col">
                            <h6 class="mb-1">Boat On-Ear Wireless</h6>
              ...
              <div class="bg-light rounded position-relative">
                <div class="text-center">
                  <div class="chat-avtar d-inline-flex mx-auto">
                    <img class="img-fluid rounded" src="/img/application/img-prod-4.jpg"
                      alt="User image">
                  </div>
                </div>
