...
<!-- Mirrored from ableproadmin.com/pages/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:35:07 GMT -->
<head>
  ...
  <body class="landing-page">
    ...
    <!-- [ Header ] start -->
    <header id="home" style="background-image: url(images/landing/img-headerbg.jpg)">
      <!-- [ Nav ] start -->
      <!-- [ Nav ] start -->
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 text-center">
            <h1 class="mb-4 wow fadeInUp" data-wow-delay="0.2s"
              >Explore One of the <span class="text-primary">Featured</span> Dashboard Template in Themeforest</h1
            >
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" src="images/landing/feature-figma.png" width="100%" />
                <a class="btn btn-light-dark mt-3" href="#"><i class="ti ti-external-link"></i> Preview Figma</a>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4">
            <div class="card bg-gray-100">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" src="images/landing/feature-components.png" width="100%" />
                <a class="btn btn-light-dark mt-3" href="#"><i class="ti ti-external-link"></i> View All Components</a>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body mt-2">
                ...
                <img class="pt-2" src="images/landing/feature-documentation.png" width="100%" />
                <a class="btn btn-light-dark mt-3" href="#"><i class="ti ti-external-link"></i> Check Documentation</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8 col-xl-6">
            ...
            <p class="mb-0 text-white text-opacity-75"
              >Each App is carefully crafted to achieve the best feature rich working concept for your project</p
            >
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6 app_dotsContainer">
            ...
            <a class="app-link wow fadeInUp" data-wow-delay="0.4s" href="#app_3">
              ...
              <p class="mb-0 text-white text-opacity-75"
                >Compose Message, List Message (email), Detailed Inbox pages well suited for any conversation based web apps.</p
              >
            </a>
            <a class="app-link wow fadeInUp" data-wow-delay="0.6s" href="#app_4">
              <h4 class="text-white f-w-500">User Management</h4>
              <p class="mb-0 text-white text-opacity-75"
                >Detailed pages for User Management like Profile settings, role, account settings, social profile and more to explore.</p
              >
            </a>
          </div>
          <div class="col-md-6 position-relative wow fadeInRight" data-wow-delay="0.4s">
            <div class="owl-carousel owl-theme screen-slide img-app-moke">
              <div class="item" data-hash="app_1">
                <img src="images/landing/chat.png" alt="img" class="img-fluid rounded" />
              </div>
              <div class="item" data-hash="app_2">
                <img src="images/landing/e-commerce.png" alt="img" class="img-fluid rounded" />
              </div>
              <div class="item" data-hash="app_3">
                <img src="images/landing/mail.png" alt="img" class="img-fluid rounded" />
              </div>
              <div class="item" data-hash="app_4">
                <img src="images/landing/social.png" alt="img" class="img-fluid rounded" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="workspace-slider-block rounded wow fadeInUp bg-gray-800" data-wow-delay="0.2s">
              <div class="workspace-slider owl-carousel owl-theme">
                <div class="item" data-hash="workspace_1"
                  ><img src="images/landing/img-slider.jpg" width="60%" alt="img" class="img-fluid img-ws-slider rounded"
                /></div>
  ...
  -->
      ...
      <div class="container title mb-0">
        <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="col-md-4 text-md-end">
            <a class="btn btn-lg btn-outline-secondary bg-gray-100" href="../dashboard/index.html" target="_blank">Check out Pro Version</a>
            <a
              class="btn btn-lg btn-primary me-2"
              data-bs-toggle="tooltip"
              data-bs-placement="bottom"
              href="https://phoenixcoded.net/item/able-pro-lite-free-admin-template/"
              target="_blank"
              title="Free version of Able Pro"
              ><i class="ti ti-brand-github"></i> Download Free</a
            >
          </div>
        </div>
      </div>
    ...
    <section class="bg-white support-team-block" style="background-image: url(images/landing/img-headerbg.jpg)">
      <div class="container title">
        <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8 col-xl-6">
                    ...
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/img/user/avatar-1.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/img/user/avatar-2.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/img/user/avatar-3.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/img/user/avatar-4.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <!-- prettier-ignore -->
                ...
                <li class="list-inline-item">
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img src="/img/user/avatar-5.jpg" alt="user-image" class="rounded-circle wid-60 hei-60" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"
                            >“An amazing template. Very good design, good quality code and also very good customer support. 💎“</p
                          >
            ...
            <div class="row">
              <div class="col-6">
                <div class="jarallax h-1001" data-jarallax-element="-100">
                  <img src=" images/landing/img-productivity-1.png" alt="image" class="img-fluid jarallax-img" />
                </div>
              </div>
              <div class="col-6">
                <div class="jarallax h-1001" data-jarallax-element="100">
                  <img src="images/landing/img-productivity-2.png" alt="image" class="img-fluid jarallax-img" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container title mb-0">
        <div class="row align-items-center">
          <div class="col-md-6 position-relative wow fadeInLeft" data-wow-delay="0.2s">
            <img src="images/landing/img-dashboard-suggestion.png" alt="img" class="img-fluid img-suggest-moke" />
          </div>
          <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
  ...
  -->
        ...
        <div class="row justify-content-center text-center">
          <div class="col-md-12">
            ...
            <p class="my-4 wow fadeInUp" data-wow-delay="0.2s"
              >From Startups to Fortune 500 companies using our Template for their product.</p
            >
            <div class="row justify-content-center client-block g-5">
              <div class="col-auto wow fadeInRight" data-wow-delay="0.4s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-eagames.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.4s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-vodafone.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.4s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-crystal-1.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.5s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-haswent-2.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.6s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-haxter-3.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.7s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-montecito-4.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.8s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-slingshot.svg" alt="img" class="img-fluid"
              /></div>
              <div class="col-auto wow fadeInRight" data-wow-delay="0.9s"
                ><img src="https://ableproadmin.com/assets/images/landing/client-totalstudio-5.svg" alt="img" class="img-fluid"
              /></div>
            </div>
          </div>
        </div>
    ...
    <!-- [ footer apps ] start -->
    <footer class="footer" style="background-image: url(images/landing/img-headerbg.jpg)">
      <div class="container title mb-0">
        <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
              <img src="https://ableproadmin.com/assets/images/logo-dark.svg" alt="image" class="img-fluid mb-3" />
              <p class="mb-4"
...
<!-- Mirrored from ableproadmin.com/pages/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:35:13 GMT -->
</html>
