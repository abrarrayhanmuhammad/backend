...
<!-- Mirrored from ableproadmin.com/pages/register-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:35:06 GMT -->
<head>
            ...
            <div class="text-center">
              ...
              <div class="d-grid my-3">
                <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                  <img src="https://ableproadmin.com/assets/images/authentication/facebook.svg" alt="img"> <span>
                    Sign Up with Facebook</span>
                </button>
                <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                  <img src="https://ableproadmin.com/assets/images/authentication/twitter.svg" alt="img"> <span> Sign
                    Up with Twitter</span>
                </button>
                <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                  <img src="https://ableproadmin.com/assets/images/authentication/google.svg" alt="img"> <span> Sign
                    Up with Google</span>
                </button>
              </div>
            </div>
