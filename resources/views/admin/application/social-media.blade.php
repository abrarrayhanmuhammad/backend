...
<!-- Mirrored from ableproadmin.com/application/social-media.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:54 GMT -->
<head>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            <div class="card social-profile">
              <img src="/img/application/img-profile-cover.jpg" alt="" class="w-100 card-img-top" />
              <div class="card-body pt-0">
                <div class="row align-items-end">
                  <div class="col-md-auto text-md-start">
                    <img class="img-fluid img-profile-avtar" src="/img/user/avatar-5.jpg" alt="User image" />
                  </div>
                  <div class="col">
                    <div class="row justify-content-between align-items-end">
                      ...
                      <div class="col-md-auto">
                        <button class="btn btn-primary me-3">Message</button>
                  ...
                  <div class="tab-pane show active" id="profile" role="tabpanel">
                    <div class="card">
                      <div class="card-body user-story-block">
                        <div class="card user-story add-story">
                          <img src="/img/application/img-story-1.jpg" class="card-img" alt="img" />
                        ...
                        <div class="horizontal-scroll">
                          <a class="card user-story" data-lightbox="/img/application/img-story-2.jpg">
                            <img src="/img/application/img-story-2.jpg" class="card-img" alt="img" />
                            <div class="card-img-overlay">
                              <img src="/img/user/avatar-2.jpg" class="wid-30 rounded-circle img-user" alt="img" />
                            </div>
                          </a>
                          <a class="card user-story" data-lightbox="/img/application/img-story-3.jpg">
                            <img src="/img/application/img-story-3.jpg" class="card-img" alt="img" />
                            <div class="card-img-overlay">
                              <img src="/img/user/avatar-3.jpg" class="wid-30 rounded-circle img-user" alt="img" />
                            </div>
                          </a>
                          <a class="card user-story" data-lightbox="/img/application/img-story-4.jpg">
                            <img src="/img/application/img-story-4.jpg" class="card-img" alt="img" />
                            <div class="card-img-overlay">
                              <img src="/img/user/avatar-4.jpg" class="wid-30 rounded-circle img-user" alt="img" />
                            </div>
                          </a>
                          <a class="card user-story" data-lightbox="/img/application/img-story-5.jpg">
                            <img src="/img/application/img-story-5.jpg" class="card-img" alt="img" />
                            <div class="card-img-overlay">
                              <img src="/img/user/avatar-5.jpg" class="wid-30 rounded-circle img-user" alt="img" />
                            </div>
                          </a>
                          <a class="card user-story" data-lightbox="/img/application/img-story-6.jpg">
                            <img src="/img/application/img-story-6.jpg" class="card-img" alt="img" />
                            <div class="card-img-overlay">
                              <img src="/img/user/avatar-1.jpg" class="wid-30 rounded-circle img-user" alt="img" />
                            </div>
                          </a>
                          <a class="card user-story" data-lightbox="/img/application/img-story-1.jpg">
                            <img src="/img/application/img-story-1.jpg" class="card-img" alt="img" />
                            <div class="card-img-overlay">
                              <img src="/img/user/avatar-4.jpg" class="wid-30 rounded-circle img-user" alt="img" />
                            </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row g-2">
                          <div class="col-md-6">
                            <a class="img-post card" data-lightbox="/img/application/img-post-1.jpg">
                              <img src="/img/application/img-post-1.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                          ...
                          <div class="col-md-6">
                            <a class="img-post card" data-lightbox="/img/application/img-post-2.jpg">
                              <img src="/img/application/img-post-2.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-search"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-6 col-xl-3">
                            <a class="img-post card" data-lightbox="/img/application/img-post-3.jpg">
                              <img src="/img/application/img-post-3.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-search"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-6 col-xl-3">
                            <a class="img-post card" data-lightbox="/img/application/img-post-4.jpg">
                              <img src="/img/application/img-post-4.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-search"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-6 col-xl-3">
                            <a class="img-post card" data-lightbox="/img/application/img-post-5.jpg">
                              <img src="/img/application/img-post-5.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-search"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-6 col-xl-3">
                            <a class="img-post card" data-lightbox="/img/application/img-post-6.jpg">
                              <img src="/img/application/img-post-6.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-search"></i>
                              </div>
                            </a>
                  ...
                  <div class="tab-pane" id="followers" role="tabpanel" aria-labelledby="followers-tab">
                    <div class="card">
                      ...
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <img class="rounded-circle img-fluid wid-40" src="/img/user/avatar-6.jpg" alt="User image" />
                            <div class="media-body mx-2">
                              <h6 class="mb-0">John Doe</h6>
                              <p class="mb-0">@John_Doe</p>
                            </div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <img class="rounded-circle img-fluid wid-40" src="/img/user/avatar-7.jpg" alt="User image" />
                            <div class="media-body mx-2">
                              <h6 class="mb-0">Addie Bass</h6>
                              <p class="mb-0">@A_Bass</p>
                            </div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <img class="rounded-circle img-fluid wid-40" src="/img/user/avatar-8.jpg" alt="User image" />
                            <div class="media-body mx-2">
                              <h6 class="mb-0">Alberta Robbins</h6>
                              <p class="mb-0">@AlbeRob12</p>
                            </div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <img class="rounded-circle img-fluid wid-40" src="/img/user/avatar-9.jpg" alt="User image" />
                            <div class="media-body mx-2">
                              <h6 class="mb-0">Agnes McGee</h6>
                              <p class="mb-0">@AgnMcGee</p>
                            </div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <img class="rounded-circle img-fluid wid-40" src="/img/user/avatar-10.jpg" alt="User image" />
                            <div class="media-body mx-2">
                              <h6 class="mb-0">Lilla Bardenova</h6>
                              <p class="mb-0">@lillabardenova</p>
                            </div>
                  ...
                  <div class="tab-pane" id="gallery" role="tabpanel" aria-labelledby="gallery-tab">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="row g-2">
                          <div class="col-md-6">
                            <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-1.jpg">
                              <img src="/img/application/img-gallery-1.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                          ...
                          <div class="col-md-6">
                            <div class="row g-2">
                              <div class="col-md-12">
                                <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-2.jpg">
                                  <img src="/img/application/img-gallery-2.jpg" alt="img" class="card-img" />
                                  <div class="card-img-overlay">
                                    <i class="ti ti-cloud-download"></i>
                                  </div>
                                </a>
                              ...
                              <div class="col-md-12">
                                <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-3.jpg">
                                  <img src="/img/application/img-gallery-3.jpg" alt="img" class="card-img" />
                                  <div class="card-img-overlay">
                                    <i class="ti ti-cloud-download"></i>
                                  </div>
                                </a>
                          ...
                          <div class="col-md-4">
                            <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-4.jpg">
                              <img src="/img/application/img-gallery-4.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-cloud-download"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-4">
                            <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-5.jpg">
                              <img src="/img/application/img-gallery-5.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-cloud-download"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-4">
                            <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-6.jpg">
                              <img src="/img/application/img-gallery-6.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-cloud-download"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-6">
                            <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-7.jpg">
                              <img src="/img/application/img-gallery-7.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-cloud-download"></i>
                              </div>
                            </a>
                          ...
                          <div class="col-md-6">
                            <a class="img-post card social-gallery-card" data-lightbox="/img/application/img-gallery-8.jpg">
                              <img src="/img/application/img-gallery-8.jpg" alt="img" class="card-img" />
                              <div class="card-img-overlay">
                                <i class="ti ti-cloud-download"></i>
                              </div>
                            </a>
              ...
              <div class="col-lg-4 col-xxl-3">
                ...
                >
                  <div class="card-body">
                    ...
                    <h3 class="mt-2 mb-4">245.3k <small class="text-muted">Followers</small></h3>
                    <h5 class="mb-0">People Stebin Ben Follows</h5>
                  </div>
                </div>
                <div class="card">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div
                      ...
                      style="background-image: url(images/application/img-event-bg.jpg)"
                    >
                      <div class="card-body">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img src="/img/user/avatar-5.jpg" alt="images" class="modal-image w-100 img-fluid" />
          </div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from ableproadmin.com/application/social-media.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:35:06 GMT -->
</html>
