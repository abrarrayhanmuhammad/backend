...
<!-- Mirrored from ableproadmin.com/forms/form_floating.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:10 GMT -->
<head>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <h5 class="mt-4">Default Value</h5>
                <hr>
                <div class="row">
                  <div class="col-md-6">
                ...
                <h5 class="mt-4">Validation styles</h5>
                <hr>
                <div class="row">
                  <div class="col-md-6">
                    <form class="form-floating mb-3">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <h5 class="mt-5">Default style</h5>
                    <hr>
                  ...
                  <div class="col-md-6">
                    <h5 class="mt-5">Custom height</h5>
                    <hr>
                    <div class="form-floating">
