...
<!-- Mirrored from ableproadmin.com/forms/form2_clipboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:14 GMT -->
<head>
    <title>Clipboard | Able Pro Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                      <textarea class="form-control" id="pc-clipboard-3" rows="6">
