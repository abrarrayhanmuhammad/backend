...
<!-- Mirrored from ableproadmin.com/forms/form2_switch.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:10 GMT -->
<head>
              ...
              <div class="card-body">
                <form>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Switches</label>
                    <div class="col-sm-9">
                      <div class="form-check form-switch custom-switch-v1 mb-2">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Inline Switches</label>
                    <div class="col-sm-9">
                      <div class="form-check form-switch custom-switch-v1 form-check-inline">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Inline States</label>
                    <div class="col-sm-9">
                      <div class="form-check form-switch custom-switch-v1 form-check-inline">
