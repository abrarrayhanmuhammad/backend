...
<!-- Mirrored from ableproadmin.com/forms/form2_daterangepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:11 GMT -->
<head>
    <title>Date Range Picker | Able Pro Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<div class="offcanvas border-0 pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
  ...
  <div class="pct-body" style="height: calc(100% - 85px)">
    ...
    <script>
      // minimum setup
      document.querySelector('#pc-date_range_picker-1').flatpickr({
        mode: 'range'
      });
      document.querySelector('#pc-date_range_picker-2').flatpickr({
        mode: 'range'
      });
      document.querySelector('#pc-date_range_picker-3').flatpickr({
        mode: 'range',
        minDate: 'today',
        dateFormat: 'Y-m-d',
        disable: [
      ...
      document.querySelector('#pc-date_range_picker-4').flatpickr({
        mode: 'range',
        dateFormat: 'Y-m-d',
...
<!-- Mirrored from ableproadmin.com/forms/form2_daterangepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:12 GMT -->
</html>
