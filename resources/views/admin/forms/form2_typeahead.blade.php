...
<!-- Mirrored from ableproadmin.com/forms/form2_typeahead.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:17 GMT -->
<head>
    <title>TypeAhead | Able Pro Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<div class="offcanvas border-0 pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
  ...
  <div class="pct-body" style="height: calc(100% - 85px)">
    ...
    <script>
      ...
      var example1_modal = new TypeAhead(document.getElementById('pc-typeahead-1-modal'), states);
    </script>
