...
<!-- Mirrored from ableproadmin.com/elements/bc_pagination.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:35:19 GMT -->
<head>
  <title>Pagination | Able Pro Dashboard Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
        ...
        <div class="col-xl-9">
          <div class="row">
            <div class="col-md-10 col-xxl-9 mb-4">
              ...
              <div>
                <a class="btn btn-sm btn-light-dark" role="button" target="_blank" href="https://getbootstrap.com/docs/5.3/components/pagination/">
