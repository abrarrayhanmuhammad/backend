...
<!-- Mirrored from ableproadmin.com/forms/form2_radio.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 May 2023 03:34:10 GMT -->
<head>
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group row mb-2">
                    <label class="col-sm-3 col-form-label">Inline</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Inline Radio Checked State </label>
                    <div class="col-sm-9">
                      <div class="form-check form-check-inline">
